...
```
![Token](/assets/images/posts/k8s-token.png)
...
![Kubernetes Plugin Installation](/assets/images/posts/k8s-plugin-jenkins.png)
...
![Jenkins Kubernetes Credentials](/assets/images/posts/jenkins-credentials.png)

**Test Connection:** Click "Test Connection" to verify the setup.

![Test Kubernetes Connection](/assets/images/posts/test-connection-jenkins-k8s.png)
...
![Jenkins Kubernetes Cloud Configuration](/assets/images/posts/jenks-k8s-cloud.png)
