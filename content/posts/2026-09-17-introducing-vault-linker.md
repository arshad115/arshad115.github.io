...
![Obsidian graph view before Vault Linker — mostly isolated notes](/assets/images/posts/vault-linker/before.png)
*Graph view before linking: most notes had no wikilinks.*

### After linking

![Obsidian graph view after Vault Linker — dense wikilink connections](/assets/images/posts/vault-linker/after.png)
...
![Vault Linker CLI dry run with parallel jobs and progress output](/assets/images/posts/vault-linker/usage.png)
...
![Vault Linker audit report in the terminal](/assets/images/posts/vault-linker/audit.png)
...
![Vault Linker plugin settings in Obsidian](/assets/images/posts/vault-linker/plugin-settings.png)
